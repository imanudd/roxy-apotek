...
public class SupplierManagementGUI extends javax.swing.JPanel {
    ...
    public SupplierManagementGUI(Connection conn) {
        ...
        tableModel = new DefaultTableModel(new Object[][] {},
                new String[] { "ID", "Nama", "Alamat", "Telepon", "Status" });
        ...
        helper.TableUtils.styleTable(jTable2);
    }
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(jButton3, javax.swing.GroupLayout.PREFERRED_SIZE, 23,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jButtonRefresh, javax.swing.GroupLayout.PREFERRED_SIZE, 23,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(30, 30, 30)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (name.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Nama supplier tidak boleh kosong.", "Error",
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (idText.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Pilih supplier terlebih dahulu dari tabel.", "Error",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
        String idText = jTextField4.getText().trim();
        if (idText.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Supplier belum dipilih atau Nonaktif!.", "Error",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
        int id = Integer.parseInt(idText);
    ...
    private void loadSuppliers() {
        ...
        List<suppliers> supplierList = uc.getSuppliersList(search, 0, limit, offset);
