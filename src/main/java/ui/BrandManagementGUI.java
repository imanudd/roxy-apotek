...
public class BrandManagementGUI extends javax.swing.JPanel {
        ...
        public BrandManagementGUI(Connection conn) {
                ...
                tableModel = new DefaultTableModel(new Object[][] {},
                                new String[] { "ID", "Nama", "Supplier", "Status" });
                ...
                helper.TableUtils.styleTable(tBrand);
        }
        ...
        private void initPaginationComponents() {
                ...
                btnNext.addActionListener(e -> {
                        currentPage++;
                        loadBrands();
                        // Ideally check if result was empty and rollback, but simple logic for now
                });
        }
        ...
        private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnCreateActionPerformed
                ...
                if (name.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "Nama brand tidak boleh kosong.", "Error",
        ...
        private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnUpdateActionPerformed
                ...
                if (idText.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "Pilih brand terlebih dahulu dari tabel.", "Error",
                                        JOptionPane.ERROR_MESSAGE);
                        return;
                }
        ...
        private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeleteActionPerformed
                String idText = textFieldId.getText().trim();
                if (idText.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "Brand belum dipilih atau Nonaktif!.", "Error",
                                        JOptionPane.ERROR_MESSAGE);
                        return;
                }
        ...
        private void loadBrands() {
                ...
                int supplierId = 0;
                if (cbSupplier != null && cbSupplier.getSelectedItem() != null) {
                ...
                List<brands> brandList = brandUc.listBrands("", supplierId, 0, limit, offset);
