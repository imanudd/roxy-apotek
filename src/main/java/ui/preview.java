...
public class preview extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                        jPanel1Layout.createSequentialGroup()
                                                .addGap(80, 80, 80)
                                                .addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 365,
                                                        Short.MAX_VALUE)
                                                .addGap(18, 18, 18))));
    ...
    private void btnExportActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        transactionUc transactionUc = new transactionUc(transactionsRepo, transactionsDetailRepo, stocksRepo,
                logStockRepo);
    ...
    private void tampilkanDataStock(List<LogStock> data) {
        ...
        model.setColumnIdentifiers(
                new String[] { "ID Stock", "Activity Name", "Nama Barang", "Jumlah", "Username", "Tanggal" });

        for (LogStock log : data) {
            model.addRow(new Object[] {
                    log.getId(), log.getActivityName(), log.getItemName(), log.getQty(), log.getUsername(),
                    log.getCreatedAt() });
        }
